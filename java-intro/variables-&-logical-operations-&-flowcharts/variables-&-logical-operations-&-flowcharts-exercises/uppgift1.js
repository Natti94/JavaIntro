...
var cars_with_drivers = cars = drivers //Räkna ut hur många bilar som har en förare;
console.log(cars = drivers)

var carpool_capacity = drivers * seats_in_car //Räkna ut det totala antalet platser alla bilar med förare har tillsammans;
...
console.log(passengers / drivers)
